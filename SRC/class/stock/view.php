		...
		<table border="0" cellpadding="5" cellspacing="1">
			...
			<tr>
				...
				<td>
					...
					for ($i = 0; $i < 5; $i++) {
					?>
						<input type="radio" name="rank" value="<?php print $i + 1; ?>"
							<?php if ($param["rank"] == $i + 1) {
								print " checked";
							} else if ($param["rank"] == "" && $i == 0) {
								print " checked";
							} ?> /><?php print fnRankName($i); ?>
					<?php
					}
			...
			<tr>
				...
				<td>
					...
					for ($i = 0; $i < 4; $i++) {
					?>
						<input type="radio" name="distance" value="<?php print $i + 1; ?>"
							<?php if ($param["distance"] == $i + 1) {
								print " checked";
							} else if ($param["distance"] == "" && $i == 0) {
								print " checked";
			...
			<tr>
				...
				<td>
					...
					?>
						<br />
						<input type="radio" name="how" value="<?php print $i + 1; ?>"
							<?php if ($param["how"] == $i + 1) {
								print " checked";
							} else if ($param["how"] == "" && $i == 0) {
								print " checked";
							} ?> /> <?php print fnHowName($i); ?>
					<?php
					}
